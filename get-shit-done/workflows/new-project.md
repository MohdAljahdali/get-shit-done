...
" + (language_instruction ? "\n\n" + language_instruction : ""), subagent_type="general-purpose", model="{researcher_model}", description="Stack research")
...
" + (language_instruction ? "\n\n" + language_instruction : ""), subagent_type="general-purpose", model="{researcher_model}", description="Features research")
...
" + (language_instruction ? "\n\n" + language_instruction : ""), subagent_type="general-purpose", model="{researcher_model}", description="Architecture research")
...
" + (language_instruction ? "\n\n" + language_instruction : ""), subagent_type="general-purpose", model="{researcher_model}", description="Pitfalls research")
```
...
" + (language_instruction ? "\n\n" + language_instruction : ""), subagent_type="gsd-roadmapper", model="{roadmapper_model}", description="Create roadmap")
```
